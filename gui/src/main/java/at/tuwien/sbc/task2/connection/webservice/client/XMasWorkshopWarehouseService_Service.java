    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(at.tuwien.sbc.task2.connection.webservice.client.XMasWorkshopWarehouseService_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = at.tuwien.sbc.task2.connection.webservice.client.XMasWorkshopWarehouseService_Service.class.getResource(".");
