...
@XmlRootElement(name = "findReadyTeddyBearsResponse", namespace = "http://tuwien.ac.at/sbc/task2/XMasWorkshopWarehouseService")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findReadyTeddyBearsResponse", namespace = "http://tuwien.ac.at/sbc/task2/XMasWorkshopWarehouseService")
